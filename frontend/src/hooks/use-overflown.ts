// source: github.com/amorriscode/use-overflow
...
export function useOverflow(
  ...
  }, [ref, refXOverflowing, refXScrollEnd, refYOverflowing, refYScrollEnd, size.width]) // Empty array ensures that effect is only run on mount and unmount
