...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      'brand-azul': customColors['brand-azul'],
      'primary-lighter': customColors.primary.lighter,
      'primary-light': customColors.primary.light,
      'primary-neutral': customColors.primary.neutral,
      'primary-dark': customColors.primary.dark,
      'primary-darker': customColors.primary.darker,
      'secondary-blue-light': customColors.secondary.blue.light,
      'secondary-blue': customColors.secondary.blue.neutral,
      'secondary-blue-dark': customColors.secondary.blue.dark,
      'secondary-azul-light': customColors.azul.light,
      ...
      gray: baseColors.coolGray,
      red: baseColors.red,
      yellow: baseColors.amber,
      lime: baseColors.lime,
      green: baseColors.emerald,
      blue: baseColors.blue,
      indigo: baseColors.indigo,
      purple: baseColors.violet,
